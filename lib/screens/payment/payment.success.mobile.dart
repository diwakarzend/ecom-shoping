...
class PaymentSuccessMobile extends StatefulWidget {
  final String paymentId;

  const PaymentSuccessMobile({super.key, required this.paymentId});

  @override
  State<PaymentSuccessMobile> createState() => _PaymentSuccessMobileState();
}

class _PaymentSuccessMobileState extends State<PaymentSuccessMobile> {
  @override
