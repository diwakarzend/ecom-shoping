...
class PaymentFailedMobile extends StatefulWidget {
  final String paymentId;
  const PaymentFailedMobile({super.key, required this.paymentId});

  @override
  State<PaymentFailedMobile> createState() => _PaymentFailedMobileState();
}

class _PaymentFailedMobileState extends State<PaymentFailedMobile> {
  @override
