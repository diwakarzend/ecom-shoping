...
class PaymentFailedTab extends StatefulWidget {
  final String paymentId;

  const PaymentFailedTab({super.key, required this.paymentId});

  @override
  State<PaymentFailedTab> createState() => _PaymentFailedTabState();
}

class _PaymentFailedTabState extends State<PaymentFailedTab> {
  @override
