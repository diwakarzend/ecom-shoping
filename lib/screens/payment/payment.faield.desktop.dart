...
class PaymentFailedDesktop extends StatefulWidget {
  final String paymentId;
  const PaymentFailedDesktop({super.key, required this.paymentId});

  @override
  State<PaymentFailedDesktop> createState() => _PaymentFailedDesktopState();
}

class _PaymentFailedDesktopState extends State<PaymentFailedDesktop> {
  @override
