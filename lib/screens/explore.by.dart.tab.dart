...
class ExploreByBrandsTab extends StatefulWidget {
  const ExploreByBrandsTab({super.key});

  @override
  State<ExploreByBrandsTab> createState() => _ExploreByBrandsTabState();
}

class _ExploreByBrandsTabState extends State<ExploreByBrandsTab> {
  int selectedPage = 1;
