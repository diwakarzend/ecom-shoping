...
class BrandTrialTabletScreen extends StatefulWidget {
  final Brand brand;

  const BrandTrialTabletScreen({
    super.key,
    required this.brand,
  });

  @override
  State<BrandTrialTabletScreen> createState() => _BrandTrialTabletScreenState();
}

class _BrandTrialTabletScreenState extends State<BrandTrialTabletScreen> with SingleTickerProviderStateMixin {
  bool listView = false;
  Brand? selectedBrand;
