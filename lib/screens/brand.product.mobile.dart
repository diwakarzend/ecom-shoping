...
class BrandProductScreenMobile extends StatefulWidget {
  const BrandProductScreenMobile({super.key});

  @override
  State<BrandProductScreenMobile> createState() => _BrandProductScreenMobileState();
}
