...
class TrailScreenDesktop extends StatefulWidget {
  const TrailScreenDesktop({
    super.key,
  });

  @override
  State<TrailScreenDesktop> createState() => _TrailScreenDesktopState();
}

class _TrailScreenDesktopState extends State<TrailScreenDesktop> {
  int trialIndex = 0;
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: (provider.banners
                            .where((element) => element.type == StringConstants.trialBanner && element.deviceType == StringConstants.deviceTypeD)
                            .isNotEmpty)
                        ? CarouselSlider(
                  ...
                  if (provider.banners.any((element) => element.type == StringConstants.trialSmall))
                    Container(
                      margin: EdgeInsets.symmetric(horizontal: width * .12),
                      alignment: Alignment.center,
                      child: Padding(
