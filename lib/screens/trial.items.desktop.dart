...
class TrialItemDesktop extends StatefulWidget {
  final String productId;

  const TrialItemDesktop({super.key, required this.productId});

  @override
  State<TrialItemDesktop> createState() => _TrialItemDesktopState();
}

class _TrialItemDesktopState extends State<TrialItemDesktop> with TickerProviderStateMixin {
                      ...
                      Expanded(
                        ...
                        child: Column(
                          ...
                          children: [
                              ...
                              TextSpan(
                                ...
                                children: [
                                  TextSpan(
                                    text: ' ${_product?.name}',
                                    style:
                                        TextHelper.normalTextStyle.copyWith(color: ColorConstants.colorGreyTwo, fontWeight: FontWeight.w600, fontSize: 15.sp),
                                  ),
                                ],
                              ),
                            ),
                            ...
                            Text(
                              'MRP Rs. ${_product?.mrp}',
                              style: TextHelper.normalTextStyle.copyWith(fontWeight: FontWeight.bold, color: Colors.black, fontSize: 15.sp),
                            ),
                            ...
                            InkWell(
                              onTap: () => _cartHelper.tryNow(provider: provider, context: context, productId: _product!.id),
                              child: Container(
                                alignment: Alignment.center,
                                height: height * .07,
                                width: width * .17,
                      ...
                      children: [
                        ...
                        if (_product != null)
                          InkWell(
                            ...
                            child: Text(
                              'View All',
                              style: TextHelper.smallTextStyle.copyWith(fontWeight: FontWeight.w500, color: ColorConstants.colorGreyThree),
                            ),
                          ),
                      ],
                    ),
