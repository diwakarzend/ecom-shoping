...
import 'package:fabpiks_web/widgets/category.items.dart';
import 'package:fabpiks_web/widgets/custom.network.image.dart';
import 'package:fabpiks_web/widgets/data.search.dart';
import 'package:fabpiks_web/widgets/deal.items.dart';
import 'package:fabpiks_web/widgets/mini.items.dart';
import 'package:fabpiks_web/widgets/new.category.items.dart';
            ...
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextHelper.smallTextStyle
                                      .copyWith(fontWeight: FontWeight.w600, color: ColorConstants.colorGreyThree),
                                ),
                              ],
                            ),
                          );
                              ...
                              Padding(
                                ...
                                child: CustomNetworkImage(
                                  imageUrl: provider.banners
                                      .firstWhere((element) => element.type == StringConstants.vendyBanner)
                                      .banner,
                                  width: width,
                                ),
                              ),
                  ...
                  if (provider.banners.where((element) => element.type == StringConstants.homeBanner).isNotEmpty)
                    Padding(
                      padding: EdgeInsets.fromLTRB(20, height * .02, 20, 0),
                      child: CarouselSlider.builder(
                        itemCount:
                            provider.banners.where((element) => element.type == StringConstants.homeBanner).length,
                        itemBuilder: (BuildContext context, int index, int i) {
                          return ClipRRect(
                            key: Key(provider.banners
                                .where((element) => element.type == StringConstants.homeBanner)
                                .toList()[index]
                                .id),
                            borderRadius: BorderRadius.circular(10),
                            child: CustomNetworkImage(
                  ...
                  if (provider.brands
                      .where(
                          (element) => element.sort == 1 || element.sort == 2 || element.sort == 3 || element.sort == 4)
                      .isNotEmpty)
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20),
                      child: Row(
