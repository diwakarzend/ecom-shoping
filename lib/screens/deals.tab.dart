...
class DealsScreentablet extends StatefulWidget {
  final bool fromCart;

  const DealsScreentablet({super.key, this.fromCart = false});

  @override
  State<DealsScreentablet> createState() => _DealsScreentabletState();
}

class _DealsScreentabletState extends State<DealsScreentablet> {
  int trialIndex = 0;
        ...
        return Scaffold(
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                if (provider.banners.where((element) => element.type == StringConstants.referBanner).isNotEmpty)
                  Padding(
                    padding: EdgeInsets.fromLTRB(20, height * .02, 20, 0),
                    child: CarouselSlider(
                      items: [
                        ...provider.banners.where((element) => element.type == StringConstants.referBanner).map(
                              (e) => ClipRRect(
