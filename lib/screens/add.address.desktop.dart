...
class AddAddressDesktop extends StatefulWidget {
  final bool fromCart;

  const AddAddressDesktop({
    super.key,
    required this.fromCart,
  });

  @override
  State<AddAddressDesktop> createState() => _AddAddressDesktopState();
}

class _AddAddressDesktopState extends State<AddAddressDesktop> {
            ...
            bottomNavigationBar: Container(
              ...
              child: InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    'Save & Continue',
                    style: TextHelper.titleStyle.copyWith(color: Colors.white, fontSize: 16.sp),
                  ),
                ),
              ),
            ),
