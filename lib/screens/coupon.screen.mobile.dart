...
class CouponScreenMobile extends StatefulWidget {
  const CouponScreenMobile({super.key});

  @override
  State<CouponScreenMobile> createState() => _CouponScreenMobileState();
}

class _CouponScreenMobileState extends State<CouponScreenMobile> {
