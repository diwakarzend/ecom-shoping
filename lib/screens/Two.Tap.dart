...
class TwoTapPage extends StatefulWidget {
  const TwoTapPage({super.key});

  @override
  State<TwoTapPage> createState() => _TwoTapPageState();
}

class _TwoTapPageState extends State<TwoTapPage> {
  List<String> items = [
    'Shop Minis',
    'Deals & Combos',
    'Free Sample',
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              margin: EdgeInsets.symmetric(horizontal: width * .15, vertical: height * .04),
              height: 70,
              width: width,
                        ...
                        GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: const Color(0xfffea348)),
                            ),
                            child: Text(
                              items[index],
                                ...
                                children: [
                                  GestureDetector(
                                    ...
                                    child: AnimatedContainer(
                                      ...
                                      padding: EdgeInsets.symmetric(horizontal: width * .01, vertical: height * .02),
                                      width: width * .22,
                                      decoration: BoxDecoration(
