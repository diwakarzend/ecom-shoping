...
class TrialScreenMobile extends StatefulWidget {
  const TrialScreenMobile({
    super.key,
  });

  @override
  State<TrialScreenMobile> createState() => _TrialScreenMobileState();
}

class _TrialScreenMobileState extends State<TrialScreenMobile> {
  int trialIndex = 0;
          ...
          child: Scaffold(
            body: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  if (provider.banners
                      .where((element) => element.type == StringConstants.trialBanner && element.deviceType == StringConstants.deviceTypeM)
                      .isNotEmpty)
                    Padding(
