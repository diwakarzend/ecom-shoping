...
class BrandItemDesktop extends StatefulWidget {
  final String productId;

  const BrandItemDesktop({super.key, required this.productId});

  @override
  State<BrandItemDesktop> createState() => _BrandItemDesktopState();
}

class _BrandItemDesktopState extends State<BrandItemDesktop> with TickerProviderStateMixin {
