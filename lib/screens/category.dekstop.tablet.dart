...
class CategoryProductsTabletScreen extends StatefulWidget {
  final String categoryId;

  const CategoryProductsTabletScreen({
    super.key,
    required this.categoryId,
  });

  @override
  State<CategoryProductsTabletScreen> createState() => _CategoryProductsTabletScreenState();
}
