...
class HotItemTablet extends StatefulWidget {
  final String productId;

  const HotItemTablet({super.key, required this.productId});

  @override
  State<HotItemTablet> createState() => _HotItemTabletState();
}

class _HotItemTabletState extends State<HotItemTablet> with SingleTickerProviderStateMixin {
