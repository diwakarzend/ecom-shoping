...
class _TermConditionTabState extends State<TermConditionTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final String policyText = 'Terms of Use\n\n'
        ...
        'Introduction\n\n'
        'The domain name www.agilecloth.com, a company incorporated under laws of India with our registered office at:-Unit No. 364, 3rd Floor, Aggarwal Plaza, Sec-14, Prashant Vihar, North West Delhi, Delhi- 110085.\n\n'
