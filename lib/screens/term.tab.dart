...
class _TermConditionTabState extends State<TermConditionTab> {
  ...
  Widget build(BuildContext context) {
    ...
    final String policyText = 'Terms of Use\n\n'
        ...
        'Introduction\n\n'
        'The domain name www.Prestigepay.in, a company incorporated under laws of India with our registered office at:- 364 3RD FLR AGGARWALPLAZA, COMM CENTER SEC14, Rithala, North West Delhi, Delhi- 110085'
