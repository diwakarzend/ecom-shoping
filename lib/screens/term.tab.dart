...
class TermConditionTab extends StatefulWidget {
  const TermConditionTab({super.key});

  @override
  State<TermConditionTab> createState() => _TermConditionTabState();
}

class _TermConditionTabState extends State<TermConditionTab> {
  @override
