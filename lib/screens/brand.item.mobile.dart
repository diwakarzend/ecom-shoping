...
class BrandItemMobile extends StatefulWidget {
  final String productId;

  const BrandItemMobile({super.key, required this.productId});

  @override
  State<BrandItemMobile> createState() => _BrandItemMobileState();
}

class _BrandItemMobileState extends State<BrandItemMobile> with TickerProviderStateMixin {
