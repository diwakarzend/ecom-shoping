...
class ShippingPolicyDesktop extends StatefulWidget {
  const ShippingPolicyDesktop({super.key});

  @override
  State<ShippingPolicyDesktop> createState() => _ShippingPolicyDesktopState();
}

class _ShippingPolicyDesktopState extends State<ShippingPolicyDesktop> {
  @override
