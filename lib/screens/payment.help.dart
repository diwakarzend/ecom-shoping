...
@RoutePage(name: 'PaymentHelpRoute')
class PaymentHelp extends StatefulWidget {
  const PaymentHelp({super.key});

  @override
  State<PaymentHelp> createState() => _PaymentHelpState();
}

class _PaymentHelpState extends State<PaymentHelp> {
          ...
          children: [
                ...
                child: ExpansionTile(
                  ...
                  children: [
                    Text(
                      ...
                      maxLines: 10000,
                      style: TextHelper.smallTextStyle.copyWith(fontWeight: FontWeight.w500, color: ColorConstants.colorGreyTwentyThree),
                    ),
                  ],
                ),
              ),
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  'Mail us at : royal.swachhlifeprivatelimited@gmail.com',
