...
class _RefundPolicyMobileState extends State<RefundPolicyMobile> {
  ...
  Shipan
  shop NO. 2 karim Mansion Behind Pharmacy college
  SHIPAN
  """;
  ...
  void initState() {
    ...
    privacyPolicyText = privacyPolicyText
        .replaceAll('Shipan Tech Private Limited', 'perceptaa IMMEDIA SERVICES PRIVATE LIMITED')
        .replaceAll('agilepaymentservicesprivatelim@gmail.com', 'info.perceptaautopilopvtltd@gmail.com')
