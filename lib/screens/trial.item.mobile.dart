...
class TrialItemMobile extends StatefulWidget {
  final String productId;

  const TrialItemMobile({super.key, required this.productId});

  @override
  State<TrialItemMobile> createState() => _TrialItemMobileState();
}

class _TrialItemMobileState extends State<TrialItemMobile> with TickerProviderStateMixin {
            ...
            child: Column(
              ...
              children: [
                      ...
                      if (_product != null)
                        CarouselSlider(
                          items: [
                            ...
                            //           imageUrl: _product?.videoThumbnail ?? '',
                            //           fit: BoxFit.cover,
                            //         ),
                            //       ),
                            //     ),
                ...
                if (_product != null)
                  ...
                  //   child: InkWell(
                  //     onTap: () => _cartHelper.tryNow(provider: provider, context: context, productId: _product!.id, fromProductPage: true),
                  //     child: Container(
                ...
                if (_product?.retargetProduct != null) SizedBox(height: height * .02),
                if (_product?.retargetProduct != null)
                  Align(
                    child: Column(
                      children: [
                        InkWell(
                        ...
                        SizedBox(height: height * .01),
                        Text(
                          'Exclusive offers for Fabpiks Users',
                          style: TextHelper.smallTextStyle.copyWith(
                            fontWeight: FontWeight.w600,
                            color: ColorConstants.colorBlackTwo,
                          ),
