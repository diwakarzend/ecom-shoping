...
class WishlistScreenTab extends StatefulWidget {
  const WishlistScreenTab({super.key});

  @override
  State<WishlistScreenTab> createState() => _WishlistScreenTabState();
}

class _WishlistScreenTabState extends State<WishlistScreenTab> {
  @override
