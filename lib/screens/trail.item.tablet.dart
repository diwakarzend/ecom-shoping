...
class TrialItemTablet extends StatefulWidget {
  final String productId;

  const TrialItemTablet({super.key, required this.productId});

  @override
  State<TrialItemTablet> createState() => _TrialItemTabletState();
}

class _TrialItemTabletState extends State<TrialItemTablet> with TickerProviderStateMixin {
              ...
              children: [
                ...
                Align(
                  ...
                  child: InkWell(
                    onTap: () {
                      if (_product != null) {
                        _cartHelper.tryNow(provider: provider, context: context, productId: _product!.id, fromProductPage: true);
                      }
                    },
                    child: Container(
