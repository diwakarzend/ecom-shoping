...
class ProductSurveyDesktop extends StatefulWidget {
  final String productId;

  // final Survey survey;
  // final Function(bool value, int totaEarning) submit;

  const ProductSurveyDesktop({
    super.key,
  ...
  @override
  State<ProductSurveyDesktop> createState() => _ProductSurveyDesktopState();
}

class _ProductSurveyDesktopState extends State<ProductSurveyDesktop> {
  ...
  initProduct(AppProvider provider) {
    ...
    if (_product != null && _product!.pSurvey != null && answers.isEmpty) {
              ...
              ? SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        width: width,
                        height: height * .06 + MediaQuery.of(context).padding.bottom + 10,
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              'Submit',
                              style: TextHelper.normalTextStyle.copyWith(color: Colors.white, fontWeight: FontWeight.bold),
                            ),
                          ),
                        ),
                      ),
